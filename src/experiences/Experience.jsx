...
const Experience = () => {
  return (
    <motion.section
      ...
      className="text-white p-4 md:p-10 text-lg flex flex-col gap-8 md:gap-10 items-center overflow-hidden"
    >
      <motion.h1 className="italic text-3xl md:text-4xl font-bold text-center tracking-wide">
        Work Experience
      </motion.h1>
      
      <motion.div className="w-full max-w-4xl p-5 md:p-8 rounded-xl flex flex-col gap-6 border-2 md:border-4 border-white/50 bg-blue-800/10 shadow-xl">
        <div className="flex flex-col gap-4">
          ...
          />
          <address className="not-italic text-sm md:text-base text-gray-300 max-w-xl leading-relaxed">
            Headquarters: 211B, Saki Vihar Road, West Chandivali IT Hub, Powai,
            Mumbai, Maharashtra 400076
          </address>
        </div>

        {/* Responsive layout container for your document attachments */}
